import { Avatar, Button, ButtonGroup, Card, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Grid, TextField, Typography } from '@mui/material'
                    ...
                    <Box sx={{ width: '100%', height: '100%', overflow: 'scroll', display: 'flex', flexDirection: 'column'}}>
                        <Box>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-around' }}>
                                <Button variant='contained' color='error' onClick={() => handleDeteteReel(dataReel.reportedTarget)}>
                                    Delete Reel
                                </Button>
