...
const ListReel = (props: ListPost) => {
  ...
  console.log('datareeel',listData)
  const type = 'Reel'
  return (
        ...
        <Card sx={{ width: '33.33%', height: 'calc(4 * 3.9 * 2.7vw)', position: 'relative' }}>
          ...
          <div
            ...
            <CardContent style={{ display: 'flex', alignItems: 'center', margin: 0, padding: 0, width: '100%' }}>
              ...
              <Typography variant="body2" color="text.secondary" style={{ fontSize: 15, color: 'white' }}>
                {listData.content}
              </Typography>
            </CardContent>
          </div>
              ...
              <Box sx={style}>
                <div>
                  <Box style={{ overflow: 'scroll', height: '350px' }}>
                    <Comment comments={comments} postDetails={listData} />
